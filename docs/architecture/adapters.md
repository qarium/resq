---
description: Internal — the adapter engine-binding that maps the adapter argument to the requests/httpx engines and their lifecycles.
---

# Adapters

!!! info "Internal surface"
    ...
    [Clients & requests](../guide/clients.md) for the user-facing surface.
